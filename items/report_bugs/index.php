...
<p>If you find a bug in Windows, you can basically wait and pray that 
...
fix it (but you'll need to pay another few hundred bucks).</p>

<p>Nearly all open source software (including Linux distributions) have 
