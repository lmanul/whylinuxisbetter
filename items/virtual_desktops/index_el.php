...
<p>Δεν ήμουν ποτέ χρήστης των Windows και υπάρχει κάτι που δεν μπορώ να
...
σε αυτό το μπάχαλο;</p>

<p>Οι επιφάνειες εργασίας είναι ένα χαρακτηριστικό που δεν θα αντάλλασσα
...
στην τρίτη οθόνη σας και ορίστε, να τος.</p>

<p>Ρίξτε μια ματιά στην παρακάτω οθόνη, και δώστε ιδιαίτερη προσοχή στην
κάτω δεξιά γωνία:</p>

<img src="Images/workspaces.png" border="0"/>

<p>Εκεί μπορείτε να αλλάξετε επιφάνεια εργασίας. Βλέπετε ότι έχει τέσσερις
...
τις συντομεύσεις του πληκτρολογίου.</p>
