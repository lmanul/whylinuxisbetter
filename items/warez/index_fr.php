...
<p>Donc, vous n'avez rien à vous reprocher, vous avez *hum* acheté des 
licenses pour tous les logiciels que vous utilisez *hum*, et personne ne 
peut vous ennuyer avec cela ? Si c'est le cas, félicitations :)</p>

<p>Cependant, pour la plupart des gens, soyons honnêtes, les logiciels 
...
copie du logiciel à chaque fois que vous le lancez.</p>

<p>Si vous utilisez Linux et n'installez que des logiciels libres, vous 
