...
<p>Vous en avez marre d'avoir un thermomètre de l'autre côté de la 
fenêtre et d'aller le consulter avant de sortir ? Un coup d'oeil à 
votre écran Linux suffit pour garder l'oeil sur le climat :</p>

<img src="Images/weather.png" />

<p>Naturellement, Linux ne vous oblige à rien, vous pouvez placer 
