...
<h2>Installera Linux</h2>

<p>Okej, så du har bestämt dig för att byta upp dig till Linux. Du kommer inte att ångra det!</p>

<p>Om du vill behålla Windows på datorn (vilket jag rekommenderar om du plötsligt
...
kommer den låta dig välja vilket operativsystem du vill köra.</p>

<p>Du borde börja med att <b>göra backup på all din data</b>. Detta är väldigt
...
vad som helst som ger dig möjligheten att rädda dina filer.</p>

<p>Sen borde du defragmentera hårddisken. Just i detta ögonblick ligger 
...
hårddisk i två delar, och installera sig själv på den andra halvan.</p>

<p>Okey, du är redp, nu är det enda du behöver göra att välja den Linuxdistribution
...
<p>När du har valt distribution och laddat ner CD-avbildningen, bränn då avbildningen
...
starta på CD:n; om den inte gör det är BIOS felinställt. (Se  "Testa Linux"-sektionen).</p>

<p>Efter det är det bara att följa instruktionerna på skärmen: för det mesta är de ganska simpla!</p>
