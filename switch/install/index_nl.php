...
<p>Als u Windows wilt behouden op uw computer (wat ik aanbeveel, in het
...
uw computer opstart, kunt u dan kiezen tussen Windows en Linux.</p>

<p>U zou eerst <b>al uw gegevens</b> moeten backuppen (een kopie maken).
Dit is erg belangrijk. We weten nooit wat er mis kan gaan. Backup daarom
uw gegevens op een cd, dvd of een andere harde schijf.</p>

<p>Dan zou u uw harde schijf moeten defragmenteren. Momenteel is zijn
...
zichzelf op het tweede deel te installeren.</p>

<p>Ok, daar bent u klaar mee. Het enige dat u nog hoeft te doen is kiezen
...
<p>Wanneer u een Linuxdistributie heeft gekozen download u de cd/dvd-images
...
(zie de Probeer Linux-pagina).</p>

<p>Volg daarna de instructies op het scherm: ze zijn meestal vrij duidelijk en
eenvoudig!</p>
