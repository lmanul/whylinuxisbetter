...
<p>Si vous souhaitez conserver Windows sur votre ordinateur (ce que 
...
<p>Avant tout <b>sauvegardez toutes vos données</b>. C'est extrêmement 
...
sauvegardez toutes vos données.</p>

<p>Ensuite, vous devez défragmenter votre disque dur. À l'instant 
...
!), et à s'installer sur la seconde partie.</p>

<p>Voilà, tout est prêt, il ne vous reste plus qu'à choisir quelle 
...
<p>Une fois que vous aurez choisi une distribution, téléchargez 
...
votre BIOS qui est mal configuré (voir la section "Essayez Linux").</p>

<p>Après cela, suivez simplement les instructions à l'écran : elles sont 
simples et claires la plupart du temps !</p>
