...
<p>Ceci dit, nombreux sont les logiciels libres qui peuvent 
parfaitement remplacer ces logiciels « essentiels » (voir <a 
href="/items/warez/index_fr.php">cette section</a>).</p>

<p>Faites un essai avec ces logiciels libres; une version Windows 
est souvent disponible, et vous pouvez l'essayer dès maintenant. 
Jetez un oeil aux captures d'écran et à la liste de leurs 
fonctionnalités, et voyez s'ils peuvent satisfaire à vos besoins.</p>

<p>S'il y a un logiciel sans lequel vous ne pouvez absolument pas 
...
appelle parfois cela "dual boot"), et choisissez selon vos besoins.</p>

<p>Il existe également un projet nommé "Wine" qui, dans certains 
