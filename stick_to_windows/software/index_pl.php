...
komercyjnych nie współpracuje z Linuksem.</p>

<p>Wiele takich programów ma jednak swoje darmowe odpowiedniki (zajrzyj do
<a href="/items/warez">tego rozdziału</a>).</p>

<p>Wypróbuj je - wiele z nich można zainstalować również w systemie Windows
i zacząć ich używać choćby od zaraz. Obejrzyj odpowiednie zrzuty ekranu i wybadaj,
czy odpowiadają one Twoim potrzebom.</p>

<p>Jeśli znajdzie się program, bez którego absolutnie nie możesz się obejść,
...
zależnie od aktualnych potrzeb.</p>

<p>Istnieje też projekt o nazwie "Wine", który, w pewnych przypadkach, pozwala na
