...
<p>Virussen, trojaanse paarden, adware, spyware... Windows laat deze allemaal eenvoudig uw computer binnendringen. De gemiddelde tijd dat een Windows-computer (verbonden met het internet en met een standaard "Service Pack 2"-installatie besmet wordt is <b>40 minuten</b> (en soms zelfs maar 30 seconds).</p>

<p>Dus u kunt ofwel 1) een firewall installeren, 2) een antivirusprogramma installeren, 3) 
...
Linux installeren en heerlijk slapen vanaf nu.</p>

<p>Zoals we al zeiden op de virus-pagina, opensourcesoftware (bv. Linux) betekent meer
...
(misschien miljoenen) mensen in plaats van een paar duizend. Dat maakt een groot verschil.</p>

<p>Eigenlijk is het niet het de <i>hoeveelheid</i> gebreken dat een systeem heeft in vergelijking
