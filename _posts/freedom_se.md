...
<p>Linux och "open source" mjukvara som är "fri". Detta betyder att licensen är en 
...
den, och återdistribuera det sålänge som licensen fortsätter att vara GPL.</p>

<p>Så varför ska du bry dig om frihet? Tänk dig att Microsoft försvinner imorgon (okej, 
...
<p>Med Open Source, om ett speciellt projekt eller företag dör, skulle koden 
