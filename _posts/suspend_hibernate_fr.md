...
<p>Lorsque votre ordinateur est en veille, vous ne pouvez pas 
...
<p>Bien sûr, Linux vous permet de faire ceci également, mais il vous 
...
programmes, etc.) exactement telles que vous les avez laissées.</p>
